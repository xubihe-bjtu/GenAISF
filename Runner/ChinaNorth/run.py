...
parser.add_argument('--data_path', type=str, default='../../datasets/ChinaNorth', help='Input Data Path')
...
parser.add_argument('--save_path', type=str, default='../../save/ChinaNorth', help='Result Save File Path')
...
parser.add_argument('--area',type=str,default='ChinaNorth',help='region')
...
parser.add_argument('--num_nodes', type=int, default= 86,help='Number of Observation Stations')
...
if args.train_type=='ST':
    ...
    if args.param_test=='True':
        save_experiment_result(args.model+f'/M/{args.M}', args.ST_model, target_name, yhat_data, args.save_path, args.train_type)
    elif args.param_test_lambda=='True':
